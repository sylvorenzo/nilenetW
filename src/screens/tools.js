...
export default function ToolsForSuccess(){
    ...
    return(
        ...
        />
            ...
            <h2>2.GSUITE</h2>
            <p>
            The GSuite was created by Google to provide businesses a comprehensive set of tools. 
            With the applications in the GSuite, you can buy a domain, 
            set up an email client, analyse website statistics, create 
            and manage ad campaigns, and much more for a cheap price. 
            ...
            Many business owners are migrating their HR processes to contemporary all-in-one 
            platforms like GoCo.io these days. Employee onboarding and offboarding, 
            document management, time-off monitoring, performance management, compliance, 
            and benefits administration are all made easier with this web-based human 
            ...
            <h2>4.GoodHire</h2>
            <p>
            Background checks, identity verifications, reference checks, employment verifications, 
            pre-hire skills testing, credit checks, drug screens, driving record checks, 
            and education/degree verifications are all required when hiring new employees, 
            especially for small firms. All of this is done through GoodHire, which requires 
            ...
            and Upwork caters to those entrepreneurs. It enables company owners to engage 
            freelancers for a variety of tasks. Whether you require web developers, 
            graphics designers, social media managers, or other services, 
            ...
            While it may seem somewhat like Yahoo Answers, Quora requires all users to 
            have verified identities and encourages responders to fill out as much 
            information about their backgrounds as possible on their accounts. 
            ...
            from any place. Telzio offers an easier method for companies to set up, 
            ...
            the developers of HipChat, is proving to be one of the best team and 
            task management tools available. With the ability to create different boards 
            and cards, specify due dates, and add comments, among other things. 
            ...
            <h2>11.Blinkist</h2>
            <p>
            Blinkist provides essential takeaways from the world's finest nonfiction books 
            in text and audio format.
            Blinkist's staff summarizes non-fiction works, allowing you to grasp important points in 
            15 minutes or less.
            </p>
            <p>
            ...
            <li>
            You still get the book's benefits without having to read it for days.
            </li>
            <li>
            You may download and use the app for free, and it provides you access to the daily choices.
            </li>
            <p>
            Blinkist Premium is required to enjoy the full service and features of the site. 
            ...
            <h2>12.Wix</h2>
            <p>
            Wix has the advantage of providing templates, so you don't have to come up 
            with a concept from scratch.

            The templates are interchangeable and customizable, 
            allowing you to create exactly the appearance and feel you want for your 
            online presence.
            The following are some of the ways that this tool may help your startup:
            </p>
            <li>
            Hundreds of templates to assist you in selecting from a huge number of designer-made alternatives.
            </li>
            <li>
            Drag and drop elements into your creation using user-friendly designs. 
            Anything on your website may be changed, customized, or added.
            </li>
            <li>
            With a personalized domain name, you may establish a professional online presence.
            </li>
            <li>
            ...
            <li>
            MoneyVersity provides educational and entertaining videos, calculators, infographics, essays, 
            and games to assist you in managing your own money.
            </li>
            <li>
            ...
            It can tell you how many visitors arrived to your site, from where they came, 
            how long they remained, and which pages they looked at.

            It has the ability to show you:
            </p>
            <li>
            Where do your visitors make the most clicks?
            </li>
            <li>
